...
var Scoreboard = function(game) {
  ...
  this.scoreText = this.game.add.bitmapText(this.scoreboard.width * 2.45, 270, 'flappyfont', '', 18);
  // this.scoreText.anchor.setTo(0.5, 0.5);
  this.add(this.scoreText);
  
  this.bestText = this.game.add.bitmapText(this.scoreboard.width * 2.45, 340, 'flappyfont', '', 18);
  // this.bestText.anchor.setTo(0.5, 0.5);
  this.add(this.bestText);

  // add our start button with a callback
  this.startButton = this.game.add.button(this.game.width/2, 425, 'startButton', this.startClick, this);
